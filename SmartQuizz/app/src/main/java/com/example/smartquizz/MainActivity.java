...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //TODO 5 errase the createSampleCategoryList function below and call createCategoryList(String[] titles,String[] description)
        //as described in TODO task number 3.1 in cas you created custom categories.
        categories = QuestionCategory.createSampleCategoryList(20);
